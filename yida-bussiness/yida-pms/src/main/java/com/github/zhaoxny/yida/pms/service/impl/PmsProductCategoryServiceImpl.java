...
import com.github.zhaoxny.yida.ums.service.PmsProductCategoryService;
...
import com.github.zhaoxny.yida.model.mapper.PmsProductCategoryAttributeRelationMapper;
import com.github.zhaoxny.yida.model.mapper.PmsProductCategoryMapper;
import com.github.zhaoxny.yida.model.mapper.PmsProductMapper;
...
public class PmsProductCategoryServiceImpl implements PmsProductCategoryService {
    ...
    @Override
    public Page<PmsProductCategory> getPage(Long parentId, Integer pageSize, Integer pageNum) {
        Page<PmsProductCategory>  query = new Page<>(pageNum, pageSize);
        QueryWrapper<PmsProductCategory> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(parentId!=null,"parent_id",parentId);
        queryWrapper.orderByDesc("sort");
        return productCategoryMapper.selectPage(query,queryWrapper);
    }
