package com.github.zhaoxny.yida.auth.aspect;
...
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(com.github.zhaoxny.yida.auth.annotation.PreAuthorize)")
    ...
    public boolean hasPermi(String permission) {
        LoginUserVo userInfo = tokenService.getLoginUser();
