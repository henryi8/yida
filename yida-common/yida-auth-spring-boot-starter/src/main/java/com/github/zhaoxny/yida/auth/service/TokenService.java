package com.github.zhaoxny.yida.auth.service;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUserVo loginUser) {
        ...
        redisUtil.setEx(ACCESS_TOKEN + token, loginUser, EXPIRE_TIME, TimeUnit.SECONDS);
        return map;
    }
    ...
    public LoginUserVo getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            LoginUserVo user = redisUtil.get(userKey);
            return user;
        }
        return null;
    }
    ...
    public void refreshToken(LoginUserVo loginUser) {
        ...
        redisUtil.setEx(userKey, loginUser, EXPIRE_TIME, TimeUnit.SECONDS);
    }
